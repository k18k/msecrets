...
import { peekSecretValue } from "@msecrets/core/workflows";

export const secretPeekCommand = new Command()
  .command("peek")
  .description("Show decrypted secret value")
  .action(async () => {
    ...
    const { info, payload } = await peekSecretValue(secretsPath, {
